...
import java.net.URL;
public class MemProPic {
    public static void main(String[] args) throws Exception {
        URL url = new URL(" https://api.linkedin.com/v2/me?projection=(Rd072uJMiO,firstName,lastName,profilePicture(displayImage~:playableStreams))");
